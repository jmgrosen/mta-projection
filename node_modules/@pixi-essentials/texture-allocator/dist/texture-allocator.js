...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@pixi/constants'), require('@pixi/core'), require('@pixi-essentials/area-allocator'), require('@pixi/math')) :
    typeof define === 'function' && define.amd ? define(['exports', '@pixi/constants', '@pixi/core', '@pixi-essentials/area-allocator', '@pixi/math'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global._pixi_essentials_texture_allocator = {}, global.PIXI, global.PIXI, global.areaAllocator, global.PIXI));
}(this, (function (exports, constants, core, areaAllocator, math) { 'use strict';
...
if (typeof _pixi_essentials_texture_allocator !== 'undefined') { Object.assign(this.PIXI, _pixi_essentials_texture_allocator); }
