...
(function (global, factory) {
    ...
    class PaintProvider 
    {
        ...
        {;PaintProvider.prototype.__init.call(this);
            ...
            const opacity = element.getAttribute('opacity') || element.style['opacity'];
            const stroke = element.getAttribute('stroke') || element.style['stroke'];
            const strokeDashArray = element.getAttribute('stroke-dasharray') || element.style['stroke-dasharray'];
            const strokeDashOffset = element.getAttribute('stroke-dashoffset') || element.style['stroke-dashoffset'];
            const strokeLineCap = element.getAttribute('stroke-linecap') || element.style['stroke-linecap'];
            const strokeLineJoin = element.getAttribute('stroke-linejoin') || element.style['stroke-linejoin'];
            const strokeMiterLimit = element.getAttribute('stroke-miterlimit') || element.style['stroke-miterlimit'];
            const strokeWidth = element.getAttribute('stroke-width') || element.style['stroke-width'];
